               ...
               <div style={{ flex: '0 0 400px', display: 'flex', flexDirection: 'column' }}>
                   ...
                   <div className="sidebar-scroll-area" style={{ background: 'linear-gradient(135deg, rgba(184, 134, 11, 0.12) 0%, rgba(205, 133, 63, 0.08) 100%)', borderRadius: '15px', padding: '20px', flex: 1, overflowY: 'auto', minHeight: 0, border: '1px solid rgba(184, 134, 11, 0.2)' }}>
                       ...
                       <Form>
                           ...
                           <div className="d-flex align-items-center mb-2"><strong className="me-3" style={{minWidth: '40px', color: '#4A3728'}}>성별:</strong><Form.Check inline type="checkbox" label="남성" name="gender" value="남성" onChange={handleCheckboxChange} /><Form.Check inline type="checkbox" label="여성" name="gender" value="여성" onChange={handleCheckboxChange} /></div>
